      ...
      {isOpen && (
        <>
          ...
          <motion.div 
            ...
            className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-md bg-[var(--bg-secondary)] shadow-2xl z-[70] rounded-[32px] p-8 text-[var(--text-primary)]"
          >
            ...
            <div className="space-y-3">
              <button 
                ...
                className="w-full p-4 rounded-2xl bg-[var(--text-primary)]/[0.02] hover:bg-[var(--text-primary)]/[0.05] transition-all flex items-center justify-between group"
              >
              ...
              <button 
                ...
                className="w-full p-4 rounded-2xl bg-emerald-500/10 hover:bg-emerald-500/20 transition-all flex items-center justify-between group border border-emerald-500/20"
              >
                <div className="flex items-center gap-4">
                  <div className="w-12 h-12 rounded-xl bg-[var(--bg-secondary)] flex items-center justify-center text-emerald-600 shadow-sm">
                    <Sparkles size={24} />
                  </div>
                  <div className="text-left">
                    <p className="font-bold text-sm text-emerald-600">AI Sample Generator</p>
            ...
            <div className="mt-8 pt-6 border-t border-[var(--border)] flex items-center justify-between">
              ...
              <button 
                onClick={onClose}
                className="px-6 py-2 bg-[var(--text-primary)] text-[var(--bg-primary)] rounded-xl text-xs font-bold hover:bg-neutral-800 transition-all"
              >
                Done
              </button>
            </div>
